document.addEventListener('DOMContentLoaded', () => {
    fetch('http://localhost:3000/products/family/Tabla de surf adultos')
        .then(response => response.json())
        .then(data => {
            console.log(data);
            const contenedor = document.getElementById('lista-tablaGrande');
        ...
        .catch(error => {
            console.error('Error al cargar las tablas de surf para adultos:', error);
        });
});