document.addEventListener('DOMContentLoaded', () => {
    fetch('http://localhost:3000/products/family/Tabla de surf niños')
        .then(response => response.json())
        .then(data => {
            console.log(data);
            const contenedor = document.getElementById('lista-tablaChica');
        ...
        .catch(error => {
            console.error('Error al cargar las tablas de surf para niños:', error);
        });
});